...
export default class Controls {
    ...
    update() {
        ...
        // this.lerp.current = GSAP.utils.interpolate(this.lerp.current%1, this.lerp.target%1, this.lerp.ease)
        ...
        // this.curve.getPointAt(this.lerp.current%1,this.position)
        // this.curve.getPointAt(this.lerp.current+0.0001%1,this.lookAt)
        // this.camera.orthographicCamera.position.copy(this.position)
